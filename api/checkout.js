...
const VIDEOS = {
  '1960': 'Дебаты Джона Кеннеди и Ричарда Никсона (1960)',
  '1967': 'Дебаты Бобби Кеннеди и Рональда Рейгана (1967)',
  '1992': 'Речь Патрика Бьюкенена (1992)',
  '2008': 'Дебаты Барака Обамы и Джона Маккейна (2008)',
  '2016': 'Дебаты Хиллари Клинтон и Дональда Трампа (2016)',
...
module.exports = async (req, res) => {
  try {
    ...
    // Если эфир прошёл, но ссылку на запись ещё не проставили — не обещаем
    // мгновенный доступ, иначе покупатель заплатит и ничего не получит.
